    ...
    rules: [
      {
        ...
        include: [
          ...
          // mono repo lib
          /node_modules(.*[/\\])+@goto[/\\]redux-listeners/,
          /node_modules(.*[/\\])+@goto[/\\]react-native-components/,
          /..[/\\]react-native-components/,
          /node_modules(.*[/\\])+@goto[/\\]react-native-oos/,
          /node_modules(.*[/\\])+@getgo[/\\]chameleon-core/,
          /node_modules(.*[/\\])+@getgo[/\\]chameleon-react-native/,
          /node_modules(.*[/\\])+@ucc[/\\]messaging-platform-state/,
        ],
        use: 'babel-loader',
      },
      /**
